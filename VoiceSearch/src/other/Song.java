...
public class Song {
	...
	private String encodeBase64(byte[] bstr) {
 	...
 	public static String main(String[] args) {
 		...
 		String result = a.recognize("identify-eu-west-1.acrcloud.com", "8ae163861c2ec2a9e7113a98ce07d5b6", "dRdNWmWa9bhFkqxkouKEUfgD1cvbxknvsfGNEWa4", postDatas, "audio", 10000);
