...
public class IdentifyProtocolV1 {
  ...
  // recognize(String host, String accessKey, String secretKey, byte[] queryData, String queryType, int timeout)
        String result = a.recognize("identify-eu-west-1.acrcloud.com", "93ea1f8f5d368bbff8b72ac5ee3bdc8b", "Ks4yr0uCelpS0mKJzWnHQY6x4BfO6dsGx1PsZ6CV", postDatas, "audio", 10000);
        return result;
    }
}